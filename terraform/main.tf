# Terraform configuration for AutoMax Car Dealership Infrastructure
terraform {
  ...
  # Backend configuration for state management (commented out for initial setup)
  # backend "s3" {
  #   bucket         = "automax-terraform-state"
  #   key            = "automax/terraform.tfstate"
  #   region         = "us-east-1"
  #   encrypt        = true
  #   dynamodb_table = "automax-terraform-locks"
  # }
}
...
resource "aws_ecs_service" "main" {
  ...
  load_balancer {
    target_group_arn = aws_lb_target_group.main.arn
    container_name   = "automax-container"
    container_port   = 80
  }
